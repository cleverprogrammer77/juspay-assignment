...
export default function PreviewArea(props) {
  ...
  const [urlSprite, setUrl] = useState(
    "https://www.seekpng.com/png/full/19-191322_scratch-cat-the-game-pose-as-you-know.png"
  );
    ...
    >
      <div className="items-end  space-x-10 float-left flex flex-row  absolute">
        ...
        <input
          ...
          type="text"
          placeholder="Submit your IMG url"
          className="text-blue-900 border-4 border-indigo-500/100 text-lg space-x-20 w-90 h-10 mx-6 p-2 rounded-lg"
        ></input>
      </div>
      <br></br>
